...
FRAME_W = 320
FRAME_H = 240
MAP_ROI = (79, 66, 167, 120)
INNER_SIZE_RATIO = 4/7
STATE_ROAD = 0
STATE_WALL = 1
STATE_GOAL = 2
STATE_BOX = 3
...
UART_ID = 12
UART_BAUD = 115200
FIXED_EXPOSURE_US = 300
CAMERA_BRIGHTNESS = -2
RAW_THRESHOLDS = {
	"box": (0, 100, -56, 127, 127, 26),
	"goal": (100, 38, 80, 127, 127, -128),
	"car_head": (63, 100, -13, -128, -128, -6),
	"car_tail": (0, 100, -50, -128, 26, 127),
	"road": (0, 53, 24, 127, -128, 127),
	"bomb": (0, 100, 65, 127, 127, -41),
}
ROAD_PIXELS_THRESHOLD = 10
ROAD_AREA_THRESHOLD = 10
GOAL_PIXELS_THRESHOLD = 10
GOAL_AREA_THRESHOLD = 10
BOX_PIXELS_THRESHOLD = 10
BOX_AREA_THRESHOLD = 10
CAR_PIXELS_THRESHOLD = 10
CAR_AREA_THRESHOLD = 10
BOMB_PIXELS_THRESHOLD = 10
BOMB_AREA_THRESHOLD = 10

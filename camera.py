...
CAMERA_BRIGHTNESS = -2
RAW_THRESHOLDS = {
	"box": (46, 100, -39, 56, 127, 7),
	"goal": (100, 0, 82, 127, -14, -128),
	"car_head": (0, 100, -8, -128, -128, -15),
	"car_tail": (47, 56, -30, -128, -128, 127),
	"road": (0, 100, -128, 80, -128, -65),
	"bomb": (0, 100, 26, 127, 127, -36),
}
...
CAR_PIXELS_THRESHOLD = 8
CAR_AREA_THRESHOLD = 7
